import type { SymbolNewsBucket } from "../hooks/useNewsSignalsData";
import type { NewsArticle } from "../hooks/useNewsSignalsData";
    ...
    <div style={{ display: "grid", gap: 18 }}>
      ...
      >
        <div style={{ display: "grid", gap: 4 }}>
          ...
          <div style={{ color: "#4b5563", fontSize: "0.95rem" }}>
            Full-width news coverage for the active watchlist. These headlines also feed the Signals tab.
          </div>
        </div>
      ...
      >
        ...
        <div style={{ padding: "1rem", borderRadius: 14, background: "#f8fafc", border: "1px solid #dbeafe" }}>
          ...
          <div style={{ color: "#64748b" }}>matched MarketAux articles</div>
        </div>
        ...
        <div style={{ padding: "1rem", borderRadius: 14, background: "#f8fafc", border: "1px solid #dbeafe" }}>
          ...
          <div style={{ color: "#64748b" }}>last MarketAux refresh</div>
        </div>
        ...
        <div style={{ padding: "1rem", borderRadius: 14, background: "#f8fafc", border: "1px solid #dbeafe" }}>
          ...
          <div style={{ fontSize: "1rem", fontWeight: 700, color: "#0f172a" }}>
            {hasKeys.marketAux ? "MarketAux ready" : "MarketAux missing"}
          </div>
      ...
      <section style={{ padding: "1rem 1.1rem", borderRadius: 16, background: "#f8fafc", border: "1px solid #e2e8f0" }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", marginBottom: 14 }}>
          ...
          <div style={{ color: "#64748b", fontSize: "0.92rem" }}>
            {newsLoading ? "Fetching latest coverage..." : `${news.length} articles loaded`}
          </div>
        </div>
        ...
        <div style={{ display: "grid", gap: 12 }}>
          {newsLoading && !news.length ? (
            ...
            <div style={{ color: "#475569" }}>No recent MarketAux coverage matched your current watchlist.</div>
          )}
        </div>
      </section>
